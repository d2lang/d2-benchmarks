...
All ten pinned original sources and eleven retained license/attribution files were downloaded over unauthenticated HTTPS and matched their recorded SHA-256 values on 2026-09-05. See [source-verification.json](source-verification.json). The corpus manifest hashes the adapted D2, all three translations, semantic maps, verification record and license files. Source-to-translation semantics are checked offline by `python3 -m benchmarks validate`.

Translated Mermaid, DOT and PlantUML files are modified representations of these same works. They retain every semantic object, group membership, edge multiplicity and plaintext label; format-specific visual differences are documented in [TRANSLATIONS.md](TRANSLATIONS.md). They remain subject to their source license and attribution; see [LICENSES.md](LICENSES.md).

## Jupyter AWS EKS infrastructure

Fixture: [jupyter_aws_eks.d2](d2/jupyter_aws_eks.d2)
...
License: MIT — [LICENSE](licenses/jupyter_aws_eks_LICENSE)
...
Fixture: [ross_overview.d2](d2/ross_overview.d2)
...
License: MIT — [LICENSE](licenses/queue_workers_LICENSE)
...
Fixture: [spyre_encoder.d2](d2/spyre_encoder.d2)
...
License: Apache-2.0 — [LICENSE](licenses/spyre_encoder_LICENSE)
...
Fixture: [mocha_soc.d2](d2/mocha_soc.d2)
...
License: Apache-2.0 (REUSE.toml explicitly covers doc/**) — [REUSE.toml](licenses/mocha_soc_REUSE.toml); [Apache-2.0.txt](licenses/mocha_soc_Apache-2.0.txt)
...
Fixture: [tpmjs_architecture.d2](d2/tpmjs_architecture.d2)
...
License: MIT — [LICENSE](licenses/tpmjs_architecture_LICENSE)
...
Fixture: [jupyter_k8s_oidc.d2](d2/jupyter_k8s_oidc.d2)
...
License: MIT — [LICENSE](licenses/jupyter_k8s_oidc_LICENSE)
...
Fixture: [leios_simulator.d2](d2/leios_simulator.d2)
...
License: Apache-2.0 (simulation/LICENSE) — [LICENSE](licenses/leios_simulator_LICENSE)
...
Fixture: [fulcro_rad.d2](d2/fulcro_rad.d2)
...
License: MIT — [LICENSE](licenses/fulcro_rad_LICENSE)
...
Fixture: [lion_reader_frontend.d2](d2/lion_reader_frontend.d2)
...
License: MIT — [LICENSE](licenses/lion_reader_frontend_LICENSE)
